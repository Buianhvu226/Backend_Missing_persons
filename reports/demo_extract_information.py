...
def analyze_child_response_gemini(response_text, missing_persons):
    try:
        ...
        Ví dụ câu trả lời chỉ cần là: "Lê Như Bảo" hoặc "Không tìm thấy" hoặc nếu có nhiều người phù hợp thì đưa ra tất cả tên người đó như ["Lê Như Bảo", "Lê Bảo Như",...]
        """
